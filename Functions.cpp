...
Functions::Functions()
{
    ...
    slime = GameData("Slime", 10, 2, 1, 0, 1, 0);
...
void Functions::buyWeapon(){
    ...
    if(choice == 1){
        ...
        std::cout << "You now roll " << player.attack << " die(s)" << std::endl;
    }
}
...
void Functions::buyArmor(){
    ...
    if(choice == 1){
        ...
        std::cout << "You now have " << player.armor << " armor." << std::endl;
    }
}
...
void Functions::monsterDamage(GameData mstr){
